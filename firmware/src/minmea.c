...
// Custom implementation of timegm for ESP-IDF, which lacks this function.
// This function converts a struct tm (in UTC) to a time_t.
time_t timegm(struct tm *tm) {
    ...
    // Use mktime to convert, which now treats tm as UTC
    ret = mktime(tm);
